...
| **Sales Dashboard** | Analytics dashboard with revenue, orders, top products and conversion charts. | HTML, CSS, Chart.js |
| **Iron Peak — Gym Landing** | Gym landing page with class schedule, pricing plans and trainer profiles. | HTML, CSS, JS |

## Discord Bots

| Bot | Description | Tech |
|-----|-------------|------|
| **Casino Streamer Bot** | Manages streamer statistics, deposit tracking and stream counts with slash commands and admin panel. | Discord.js, Node.js, MongoDB |
| **Affiliate Notifier Bot** | Auto-detects when users stop using an affiliate code and notifies via DM with role management. | Discord.js, Node.js, MongoDB |
| **Leaderboard Bot** | Syncs live wager race data from casino APIs, posts auto-updates with top-10 rankings. | Discord.js, Node.js, Cron Jobs |
